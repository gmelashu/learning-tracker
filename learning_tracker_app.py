...
# Auto-generated coach message
    if weekly_completion >= 90:
        coach_message = f"🌟 Incredible work this week, {child_name}! You completed nearly every session — your dedication is truly inspiring."
    elif books_read >= goal:
        coach_message = f"📚 Amazing, {child_name}! You hit your book goal this month — you're growing into a reading star!"
    elif sweet_rate >= 80:
        coach_message = f"⏱️ Great focus! You perform best during {sweet_spot_time} minute sessions. That’s your sweet spot!"
    elif active_days >= 5:
        coach_message = f"🔥 Your learning streak is strong — {active_days} active days this week is no small feat!"
    else:
        coach_message = f"Keep it up, {child_name}! Every session helps you grow — let’s aim for even more next week. I believe in you! 💪"
